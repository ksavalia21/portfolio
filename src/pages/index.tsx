  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="im keyur, a 22 year old software engineer and designer based in the United States."
        />
      ...
      >
        ...
        >
          <AnimatedText element="h2" text="Keyur" />
          <AnimatedText element="h2" text="Savalia" />
